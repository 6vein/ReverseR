    ...
    public abstract class FernflowerDecompiler : CommonDecompiler
    {
        ...
        public FernflowerDecompiler(IContainerProvider containerProvider)
        {
            ...
            if (File.Exists(CommonStorage.GlobalConfig.ConfigPrefix + "fernflower,json"))
                Preferences = JsonConvert.DeserializeObject(File.ReadAllText(CommonStorage.GlobalConfig.ConfigPrefix + "fernflower,json"), typeof(FernflowerPreferences)) as FernflowerPreferences;
